  ...
  <div class="register-view">
    <template v-if="isComplete">
      ...
      <form method="post" onsubmit="return false">
        ...
        <div class="form-alias">
          <label>
            <strong>token</strong>
            <input v-model="token" type="text" name="token" placeholder="token" />
          </label>
        </div>
    ...
    <template v-else>
      ...
      <form method="post" @submit.prevent="onSubmit()">
        <p v-if="error" class="tip error">
          {{ error }}
        </p>
        <div class="form-alias">
          <label>
            <strong>邮箱</strong>
            <input v-model.trim="email" type="text" name="email" placeholder="邮箱" />
          </label>
        </div>
        <div class="form-pwd">
          <label>
        ...
        <div class="form-submit">
          <button class="submit" type="submit" :disabled="isDisabled" :class="{disable: isDisable}">
            {{registerState}}
          </button>
        </div>
      </form>
...
<style lang="scss" scoped>
  .register-view {
    ...
    form {
      ...
      .form-pwd input, .forme-name input {
        padding-right: 4rem;
        border-top: 0;
      }
